...
- If you are using Synology 7.2, launch the [Container Manager app](https://kb.synology.com/en-global/DSM/help/ContainerManager/docker_desc?version=7).  Otherwise, (make sure [the Docker app is installed](https://blog.pavelsklenar.com/how-to-install-and-use-docker-on-synology/){:target="_blank"} and running correctly.
